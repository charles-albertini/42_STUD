...
{
	std::cout << "Specifique constructor ClapTrap called" << std::endl;
	this->name = name;
	hit_points = 10;
	energy_points = 10;
	attack_damage = 0;
...
void ClapTrap::takeDamage(unsigned int amount)
{
	...
	else
	{
		...
		std::cout << name << " hit points is now " << hit_points << std::endl;
		std::cout << std::endl;
	}
}
...
void ClapTrap::beRepaired(unsigned int amount)
{
	energy_points--;
	if(energy_points < 0)
		std::cout << name << " has 0 point of energy" << std::endl;
	if (hit_points <= 0)
		std::cout << name << " is dead" << std::endl;
	else if (energy_points >= 0)
	{
		hit_points += amount;
		std::cout << name << " repairs itself of " << amount << " points" << std::endl;
		std::cout << name << " hit points is now " << hit_points << std::endl;
		std::cout << name << " energy point is now " << energy_points << std::endl;
		std::cout << std::endl;
	}
}